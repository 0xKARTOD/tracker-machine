...
_recipes_pil_prescript(['PcxImagePlugin', 'TgaImagePlugin', 'GifImagePlugin', 'FliImagePlugin', 'BlpImagePlugin', 'XbmImagePlugin', 'BufrStubImagePlugin', 'MpoImagePlugin', 'FitsStubImagePlugin', 'PixarImagePlugin', 'Hdf5StubImagePlugin', 'WebPImagePlugin', 'EpsImagePlugin', 'Jpeg2KImagePlugin', 'CurImagePlugin', 'SunImagePlugin', 'IcnsImagePlugin', 'MspImagePlugin', 'FpxImagePlugin', 'TiffImagePlugin', 'PngImagePlugin', 'WmfImagePlugin', 'PcdImagePlugin', 'IcoImagePlugin', 'McIdasImagePlugin', 'SgiImagePlugin', 'DdsImagePlugin', 'ImImagePlugin', 'PalmImagePlugin', 'FtexImagePlugin', 'PdfImagePlugin', 'MpegImagePlugin', 'GbrImagePlugin', 'IptcImagePlugin', 'BmpImagePlugin', 'GribStubImagePlugin', 'ImtImagePlugin', 'PsdImagePlugin', 'DcxImagePlugin', 'PpmImagePlugin', 'XVThumbImagePlugin', 'FitsImagePlugin', 'JpegImagePlugin', 'MicImagePlugin', 'XpmImagePlugin', 'SpiderImagePlugin'])
