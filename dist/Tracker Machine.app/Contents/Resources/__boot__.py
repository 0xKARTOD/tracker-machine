...
_recipes_pil_prescript(['FtexImagePlugin', 'MspImagePlugin', 'MicImagePlugin', 'FitsImagePlugin', 'Jpeg2KImagePlugin', 'SgiImagePlugin', 'XpmImagePlugin', 'TgaImagePlugin', 'GribStubImagePlugin', 'PdfImagePlugin', 'Hdf5StubImagePlugin', 'McIdasImagePlugin', 'DdsImagePlugin', 'WmfImagePlugin', 'CurImagePlugin', 'PcxImagePlugin', 'SunImagePlugin', 'WebPImagePlugin', 'GifImagePlugin', 'PngImagePlugin', 'IptcImagePlugin', 'XbmImagePlugin', 'FpxImagePlugin', 'ImImagePlugin', 'IcoImagePlugin', 'BufrStubImagePlugin', 'ImtImagePlugin', 'PcdImagePlugin', 'BmpImagePlugin', 'PpmImagePlugin', 'MpoImagePlugin', 'PixarImagePlugin', 'FitsStubImagePlugin', 'EpsImagePlugin', 'FliImagePlugin', 'PsdImagePlugin', 'MpegImagePlugin', 'BlpImagePlugin', 'SpiderImagePlugin', 'XVThumbImagePlugin', 'JpegImagePlugin', 'IcnsImagePlugin', 'TiffImagePlugin', 'GbrImagePlugin', 'DcxImagePlugin', 'PalmImagePlugin'])
